...
@Component({
  selector: 'app-rotighar',
  templateUrl: './rotighar.component.html',
  styleUrls: ['./rotighar.component.css'],
})
export class RotigharComponent implements OnInit {
  hotel: string = 'RotiGhar';
